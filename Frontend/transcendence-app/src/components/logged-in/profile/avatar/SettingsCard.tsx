...
type Props = {
	...
	handleArea:(event: React.MouseEvent<HTMLElement>, newArea: 'border' | 'background' | null) => void,
...
export default function SettingsCard({previewChangeTopColor, previewChangeBotColor, handleArea, selectedArea, toogleDisplaySettings, saveColorChanges}: Props) {
	...
	<div className={styles.settingsCard}>
		<Stack direction="row" spacing="3rem">
			...
			<Stack direction="row" spacing="0.5rem">
				<ToggleButtonS value="cancel" aria-label="cancel-change-color" onClick={toogleDisplaySettings}>
						<CancelIcon fontSize="small" sx={{color: '#ff5555'}}/>
				</ToggleButtonS>

				<ToggleButtonS value="valid" aria-label="valid-change-color" onClick={saveColorChanges}>
